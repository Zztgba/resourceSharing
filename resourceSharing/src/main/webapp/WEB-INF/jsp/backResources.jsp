...
<body>
<div class="page_nav">
    <p>当前位置：<span>资源管理</span>/<span>未通过的资源</span></p>
</div>
    ...
    <table>
        ...
        <c:forEach items="${list}" var="resourceVo" varStatus="vs">
            <tr>
                ...
                <td><a href="${pageContext.request.contextPath}/ResourceManager/updateResourceState/1.action?id=${resourceVo.id}&&index=1">审核</a></td>
            </tr>
        </c:forEach>
        </thead>
    </table>
